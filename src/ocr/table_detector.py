...
def detect_blok3_with_ocr(
    ...
    """
    FAST: Detect BLOK III region using Tesseract OCR with PARALLEL dual-direction scan.
    - Scans TOP 30% for "Rekapitulasi" (upper boundary) - PARALLEL
    - Scans BOTTOM 30% for "Keterangan" (lower boundary) - PARALLEL
